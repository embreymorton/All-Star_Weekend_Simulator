public class DunkList {
    ...
    //ELITE Dunks
    public static Dunk three_sixty_windmill = new Dunk("360 Windmill", 100, 48, Dunk.DunkType.ELITE);

    //LEGENDARY Dunks
    public static Dunk free_throw_line = new Dunk("Free Throw Line", 110,50, Dunk.DunkType.LEGENDARY);
    public static Dunk windmill_honeydip = new Dunk("Windmill Honey-Dip", 105, 50, Dunk.DunkType.LEGENDARY);
